...
// import DepImg from "../../assets/images/texa/leaverequest.jpg"
import './style.scss'
                ...
                <Card className="dept-details-card">
                    <CardBody>
                        <Modal
                            ...
                            size="lg"
                        >
                            <ModalHeader toggle={this.toggleModal} className="modal-colored-header bg-primary">Leaverequest Details</ModalHeader>
                            <ModalBody>
                                <Row>
                                    <Col md={6}>
