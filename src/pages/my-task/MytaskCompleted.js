    ...
    // },
    {
      ...
      formatter: (cell, row, rowIndex, formatExtraData) => (
        <div style={{ lineHeight: "normal", margin: 0 }}>
          <p id="name">
            {row.task_attachment !== "" ? (
              <Button id="download" onClick={() => edit(row, rowIndex)}>
  ...
  return (
    <>
      <React.Fragment>
        ...
        {props.taskdata && props.taskdata.completed_task && (
          <BootstrapTable
            bootstrap4
            keyField={"dep_id"}
            data={props.taskdata.completed_task}
            columns={columns}
...
export default TaskerCompleted;
