...
const WeeklyReportConfig = (props) => {
    ...
    const GetWeeklyreport = () => {
        if (employee !== null && datemonth !== null && employee !== '' && datemonth !== '') {
            ...
            props.getWeeklyreportList(data);
        } else {
            emptyAllFields();
        }
    };
    ...
    let workData =
        props.weeklyreport &&
        props.weeklyreport.weeklyreport &&
        props.weeklyreport.weeklyreport.data &&
        props.weeklyreport.weeklyreport.data.weekly_checklist &&
        props.weeklyreport.weeklyreport.data.weekly_checklist;
                    ...
                    <React.Fragment>
                        ...
                        <Row>
                            ...
                            <Col md={4} className="my-auto text-right">
                                <Button color="danger" onClick={() => GetWeeklyreport()}>
                                    Get Weeklyreport Report
                                </Button>
                            </Col>
                        </Row>

                        {props.weeklyreport && props.weeklyreport.listloading && <LoaderWidget />}
                        {props.weeklyreport &&
                            props.weeklyreport.weeklyreport &&
                            props.weeklyreport.weeklyreport.data &&
                            props.weeklyreport.weeklyreport.data && (
                                <>
                                    <BootstrapTable
                                        ...
                                        data={
                                            ...
                                            props.weeklyreport.weeklyreport &&
                                            props.weeklyreport.weeklyreport.data &&
                                            props.weeklyreport.weeklyreport.data.weekly_report
                                        }
                                        columns={columns}
...
export default connect(mapStateToProps, { getEmployeeList, getWeeklyreportList })(WeeklyReportConfig);
