...
// import DepImg from "../../assets/images/texa/designation.jpg"
import './style.scss'
                ...
                <Card className="dept-details-card">
                    <CardBody>
                        <Modal
                            ...
                            size="lg"
                        >
                            <ModalHeader toggle={this.toggleModal} className="modal-colored-header bg-primary">Designation Details</ModalHeader>
                            <ModalBody>
                                <Row>
                                    <Col md={6}>
