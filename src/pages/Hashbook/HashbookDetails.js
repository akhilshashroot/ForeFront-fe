...
// import DepImg from "../../assets/images/texa/hashbook.jpg"
import './style.scss'
                ...
                <Card className="dept-details-card">
                    <CardBody>
                        <Modal
                            ...
                            size="lg"
                        >
                            <ModalHeader toggle={this.toggleModal} className="modal-colored-header bg-primary">Hashbook Details</ModalHeader>
                            <ModalBody>
                                <Row>
                                    <Col md={6}>
